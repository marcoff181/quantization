...
Usage example:
  python pipelines/img2img/analyze_modes.py \
    --method ft_default:results/img2img/detector_img2img_results.csv:results/img2img/detector_real_results.csv:default \
    --method patch_majority:results/img2img/patch_detector_img2img_results.csv:results/img2img/detector_real_all_modes.csv:patch_majority \
    --detector CLIP-D \
    --output_dir figures/mode_comparison
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_dir",
        default=str(_ROOT / "figures" / "mode_comparison"),
