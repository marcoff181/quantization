...
if str(_ROOT / "generators" / "shared") not in sys.path:
    sys.path.insert(0, str(_ROOT / "generators" / "shared"))
...
def build_parser():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=str(Path(__file__).resolve().parents[2] / "data" / "fake" / "txt2img"),
