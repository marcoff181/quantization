...
BASE_TXT2IMG_BATCHES: List[Dict[str, object]] = [
    {"script": "quantization/txt2img.py", "model": "sdxl", "quant": "fp16"},
    {"script": "quantization/txt2img.py", "model": "sdxl", "quant": "fp8"},
    {"script": "quantization/txt2img.py", "model": "sdxl", "quant": "fp4"},
    {"script": "quantization/txt2img.py", "model": "sd3", "quant": "fp16"},
    {"script": "quantization/txt2img.py", "model": "sd3", "quant": "fp8"},
    {"script": "quantization/txt2img.py", "model": "sd3", "quant": "fp4"},
    {"script": "quantization/txt2img.py", "model": "sd35", "quant": "fp16"},
    {"script": "quantization/txt2img.py", "model": "sd35", "quant": "fp8"},
    {"script": "quantization/txt2img.py", "model": "sd35", "quant": "fp4"},
    {"script": "quantization/txt2img.py", "model": "sd15", "quant": "fp16"},
    {"script": "quantization/txt2img.py", "model": "sd15", "quant": "fp8"},
    {"script": "quantization/txt2img.py", "model": "sd15", "quant": "fp4"},
    {"script": "quantization/txt2img.py", "model": "z-image", "quant": "fp16"},
    {"script": "quantization/txt2img.py", "model": "z-image", "quant": "fp8"},
    {"script": "quantization/txt2img.py", "model": "z-image", "quant": "fp4"},
    {"script": "quantization/txt2img.py", "model": "pg25", "quant": "fp16"},
    {"script": "quantization/txt2img.py", "model": "pg25", "quant": "fp8"},
    {"script": "quantization/txt2img.py", "model": "pg25", "quant": "fp4"},
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Prompts file to pass to txt2img. Defaults to quantization/prompts_filtered.txt when available.",
    )
    parser.add_argument(
        "--only_missing",
        action="store_true",
...
def _resolve_prompts_file(prompts_file: Optional[str]) -> Optional[Path]:
    if prompts_file:
        ...
        if path.is_absolute():
            return path
        return (PROJECT_ROOT / "quantization" / path).resolve()
    default_path = PROJECT_ROOT / "quantization" / "prompts_filtered.txt"
