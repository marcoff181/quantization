...
# ----- paths & constants -----
DEFAULT_CSV = Path("/media/CrispyMcMarkInc/patch_detector_img2img_results.csv")
DEFAULT_FIGURES_DIR = Path("/media/CrispyMcMarkInc/figures/img2img_clipd_mode_comparison")
