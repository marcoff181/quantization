...
# ----- paths & constants -----
DEFAULT_CSV = Path("/media/CrispyMcMarkInc/patch_detector_real_all_modes.csv")
DEFAULT_FIGURES_DIR = Path("/media/CrispyMcMarkInc/figures/img2img_clipd_real_analysis")
