#!/usr/bin/env python3
"""Analyze detector performance for img2img outputs generated by generate_images.py."""
...
DEFAULT_CSV = Path("/media/CrispyMcMarkInc/detector_results.csv")
...
def save_figures(df: pd.DataFrame, output_dir: Path = DEFAULT_FIGURES_DIR) -> None:
    ...
    plot_metric_grid_seaborn(
        ...
        output_path=output_dir / "img2img_comparative_fake_rate_by_model_quantization_detector.png",
        cmap="mako",
    ...
    plot_metric_grid_seaborn(
        ...
        output_path=output_dir / "img2img_comparative_confidence_by_model_quantization_detector.png",
        cmap="flare",
    ...
    if "avg_elapsed_time" in base.columns and base["avg_elapsed_time"].notna().any():
        plot_metric_grid_seaborn(
            ...
            output_path=output_dir / "img2img_comparative_elapsed_time_by_model_quantization_detector.png",
            cmap="crest",
...
def main(csv_path: str) -> None:
    ...
    if not generation_summary.empty:
        summary_path = DEFAULT_FIGURES_DIR / "generation_summary.csv"
        ...
        detailed_out = DEFAULT_FIGURES_DIR / "img2img_comparative_generation_summary_detailed.csv"
